//
//  MDProductDetailViewController.swift
//  Paris GS
//
...
class MDProductDetailViewController: UIViewController, ENSideMenuDelegate, UIScrollViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout,  CollectionViewSelectedProtocol, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, WKNavigationDelegate  {
        ...
        if(collectionView.tag == 1)
        {
            ...
            if(indexPath.section == productDetailsManager.SectionDescription)
            {
                ...
                if(productDetailsManager.productPresentation.longDescription != nil)
                {
                    ...
                    cell.myActivityIndicator.center = (cell.webView?.center)!
 ...
 */
    ...
    // MARK: - KWebView Delegate

    func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        let descriptionCell = collectionView.cellForItem(at: IndexPath.init(row: 0, section: productDetailsManager.SectionDescription)) as? MDDescriptionCell
        if(descriptionCell != nil)
        {
            descriptionCell?.myActivityIndicator.stopAnimating()
        }
    }
    ...
    func webView(_ webView: WKWebView, didCommit navigation: WKNavigation!) {
        ...
        if(descriptionCell != nil)
        {
            descriptionCell?.myActivityIndicator.startAnimating()
        }
